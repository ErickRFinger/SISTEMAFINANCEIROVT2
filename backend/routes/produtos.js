    ...
    try {
        ...
        const { data, error } = await supabase
            ...
            .insert([{
                ...
                nome,
                descricao,
                preco_venda: (preco_venda === '' || preco_venda === undefined) ? 0 : parseFloat(preco_venda),
                preco_custo: (preco_custo === '' || preco_custo === undefined) ? 0 : parseFloat(preco_custo),
                quantidade_estoque: (quantidade_estoque === '' || quantidade_estoque === undefined) ? 0 : parseInt(quantidade_estoque),
                tipo_item: tpItem,
                localizacao,
                margem_lucro,
                imagem_url
